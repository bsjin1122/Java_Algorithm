...
/*
 * GroupAlgorithm 그룹 알고리즘 : 특정 키 값에 해당하는 그룹화된 합계 리스틀 만들기 
 */
public class GroupAlgorithm {
    ...
    public static void main(String[] args) {
        //[1] Input
        List<Record> records = getAll(); // 입력데이터
        List<Record> groups = new ArrayList<Record>(); //출력데이터
        ...
        printData("[2] 이름으로 그룹된 데이터: ", groups);
    }
}
